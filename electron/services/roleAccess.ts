...
export const ROLE_WRITE_ACCESS: Record<string, ModuleName[] | "*"> = {
  ...
  // Runs the office: the civil + religious registers and tokens.
  Secretary: ["members", "families", "marriages", "deaths", "committee", "tokens", "certificates"],
  // Handles the money.
  ...
  // Day-to-day data entry + token collection.
  Staff: ["members", "families", "tokens"],
