...
export function buildCollectionSheetHtml(tokenList: any[], event: any): string {
  ...
  const labels = ml ? {
    title:'ടോക്കൺ ശേഖരണ ഷീറ്റ്', sub:`${name} · മഹല്ല് മാനേജ്മെന്റ് സിസ്റ്റം`, no:'നമ്പർ', token:'ടോക്കൺ', family:'കുടുംബം', house:'വീട്ട് നമ്പർ', ward:'വാർഡ്', collected:'ശേഖരിച്ചു', signature:'ഒപ്പ്', verify:'ശേഖരിച്ചതായി അടയാളപ്പെടുത്തുന്നതിന് മുമ്പ് ഓരോ ടോക്കണും പരിശോധിക്കുക.', total:'ആകെ'
  } : {
    title:'Token Collection Sheet', sub:`${name} · Mahallu Management System`, no:'No.', token:'Token', family:'Family', house:'House No.', ward:'Ward', collected:'Collected', signature:'Signature', verify:'Verify each returned token before marking collected.', total:'Total'
  };
