...
const api = {
  ...
  families: {
    ...
    archive: (id: number, reason: string) => ipcRenderer.invoke("security:archiveFamily", id, reason),
    restore: (id: number, reason?: string) => ipcRenderer.invoke("security:restoreFamily", id, reason || ""),
    history: (id: number) => ipcRenderer.invoke("security:familyHistory", id),
    createFromMembers: (memberIds: number[], data: any, headMemberId: number, reason: string) => ipcRenderer.invoke("security:createFamilyFromMembers", memberIds, data, headMemberId, reason),
  },
  members: {
    ...
    archive: (id: number, reason: string) => ipcRenderer.invoke("security:archiveMember", id, reason),
    restore: (id: number, reason?: string) => ipcRenderer.invoke("security:restoreMember", id, reason || ""),
    history: (id: number) => ipcRenderer.invoke("security:memberHistory", id),
    move: (ids: number[], familyId: number, reason: string) => ipcRenderer.invoke("security:moveMembers", ids, familyId, reason, "ExistingFamily"),
    moveHistory: (id: number) => ipcRenderer.invoke("security:memberMoveHistory", id),
  ...
  marriages: {
    list: (filter?: any) => ipcRenderer.invoke("marriages:list", filter), get: (id: number) => ipcRenderer.invoke("marriages:get", id), create: (data: any) => ipcRenderer.invoke("marriages:create", data), update: (id: number, data: any) => ipcRenderer.invoke("marriages:update", id, data), remove: (id: number) => ipcRenderer.invoke("marriages:remove", id),
  },
  deaths: {
    list: (filter?: any) => ipcRenderer.invoke("deaths:list", filter), get: (id: number) => ipcRenderer.invoke("deaths:get", id), create: (data: any) => ipcRenderer.invoke("deaths:create", data), update: (id: number, data: any) => ipcRenderer.invoke("deaths:update", id, data), remove: (id: number) => ipcRenderer.invoke("deaths:remove", id),
  },
  welfare: {
  ...
  audit: { list: (filter?: any) => ipcRenderer.invoke("audit:list", filter) },
  settings: { load: () => ipcRenderer.invoke("settings:load"), save: (data: any) => ipcRenderer.invoke("settings:save", data) },
  ...
  dialog: { showSave: (defaultName: string, filters: any[]) => ipcRenderer.invoke("dialog:showSave", defaultName, filters) },
