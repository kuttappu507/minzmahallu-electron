-- V032: normalize stored Indian WhatsApp numbers to international form (91 + 10 digits).
UPDATE families
...
VALUES (32, 'WhatsApp: normalize existing Indian phone numbers for messaging');
