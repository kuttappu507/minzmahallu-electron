...
const sectionLabel:Record<string,string>={Management:"മാനേജ്മെന്റ്",Finance:"സാമ്പത്തികം",Registers:"രജിസ്റ്ററുകൾ",System:"സിസ്റ്റം"};
...
function roleLabel(role:string|undefined,ml:boolean){if(!role)return "—";if(!ml)return role;return ({Administrator:"അഡ്മിനിസ്ട്രേറ്റർ",President:"പ്രസിഡന്റ്",Secretary:"സെക്രട്ടറി",Treasurer:"ട്രഷറർ",Imam:"ഇമാം",Staff:"സ്റ്റാഫ്",Auditor:"ഓഡിറ്റർ",Manager:"മാനേജർ",Operator:"ഓപ്പറേറ്റർ",Viewer:"വ്യൂവർ"} as Record<string,string>)[role]||role;}
