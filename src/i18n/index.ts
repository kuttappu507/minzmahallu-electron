...
const translations: Record<string, { en: string; ml: string }> = {
  ...
  dth_burial_date: { en: "Burial Date", ml: "ദഫനം ചെയ്ത തീയതി" },
  ...
  set_receipt_prefix_hint: {
    ...
    ml: "ഈ മഹല്ല് അക്ഷരങ്ങളിൽ എല്ലാ നമ്പറും തുടങ്ങും — ദാന രസീറ്റ് MMJM/DN/26/09/001, വരിസംഖ്യ രസീറ്റ് MMJM/SB/26/09/001, സർട്ടിഫിക്കറ്റ് MMJM/DT/26/09/001 (DT മരണം, MB അംഗത്വം, RS താമസം, MR നികാഹ്, NOC). അതുകൊണ്ട് രണ്ട് മഹല്ലുകൾക്ക് ഒരേ നമ്പർ വരില്ല; ദാനവും വരിസംഖ്യയും ഒരേ നമ്പർ പങ്കിടില്ല. RCP ആയിട്ടുവയ്ക്കുക അല്ലെങ്കിൽ കാലിയാക്കിവയ്ക്കുക — മഹല്ല് പേരിന്റെ അക്ഷരങ്ങൾ (വാക്കുകളുടെ ഇനീഷ്യലുകൾ, അല്ലെങ്കിൽ ആദ്യ മൂന്നക്ഷരങ്ങൾ) സ്വയമേവ ഉപയോഗിക്കും.",
  },
  ...
  close_confirm_sub: { en: "All data is saved. Backups continue as scheduled.", ml: "എല്ലാ ഡാറ്റയും സേവ് ചെയ്തിട്ടുണ്ട്. ബാക്കപ്പ് ക്രമീകരണം അടുത്ത തവണയും സ്വയമേവ നടക്കും." },
  ...
  ui_saved_success: { en: "Saved successfully", ml: "വിജയകരമായി സേവ് ചെയ്തു" },
  ui_saved_updated: { en: "Changes saved successfully", ml: "മാറ്റങ്ങൾ വിജയകരമായി സേവ് ചെയ്തു" },
  wa_sending_receipt: { en: "Sending receipt on WhatsApp…", ml: "വാട്ട്സ്ആപ്പിൽ രസീറ്റ് അയയ്ക്കുന്നു…" },
  ...
  ui_confirm_delete: { en: "Confirm Delete", ml: "ഇല്ലാതാക്കൽ സ്ഥിരീകരിക്കുക" },
  ...
  cert_issued_to_name: { en: "Issued To (Name)", ml: "നൽകിയിട്ടുള്ളത് (പേര്)" },
  cert_issued_placeholder: { en: "Full name of the person the certificate is issued to", ml: "സർട്ടിഫിക്കറ്റ് നൽകിയിട്ടുള്ള വ്യക്തിയുടെ പൂർണ്ണ പേര്" },
  cert_select_record: { en: "Please select a record from the list", ml: "ദയവായി ലിസ്റ്റിൽ നിന്ന് ഒരു രേഖ തിരഞ്ഞെടുക്കുക" },
  cert_issued_to_required: { en: "Issued To name is required for residence certificates", ml: "വസതി സർട്ടിഫിക്കറ്റിന് നൽകിയിട്ടുള്ള പേര് ആവശ്യമാണ്" },
