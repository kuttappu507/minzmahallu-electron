...
const FIELD_LABELS: Record<string, [string, string]> = {
  ...
  marital_status: ["Marital status", "വിവാഹ ബന്ധം"],
  mobile: ["Mobile", "മൊബൈൽ"],
  email: ["Email", "ഇമെയിൽ"],
  emergency_contact: ["Emergency contact", "അടിയന്തര സമ്പർക്കം"],
  relationship: ["Relationship", "ബന്ധം"],
  status: ["Status", "നില"],
  nationality: ["Nationality", "പൗരത്വം"],
  address: ["Address", "വിലാസം"],
  father_id: ["Father (linked member)", "പിതാവ് (ബന്ധമുള്ള അംഗം)"],
  mother_id: ["Mother (linked member)", "മാതാവ് (ബന്ധമുള്ള അംഗം)"],
  spouse_id: ["Spouse (linked member)", "ഇണ (ബന്ധമുള്ള അംഗം)"],
  ...
  payment_method: ["Payment method", "പണമടയ്ക്കൽ രീതി"],
