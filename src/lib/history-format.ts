...
const FIELD_LABELS: Record<string, [string, string]> = {
  ...
  marital_status: ["Marital status", "വിവാഹ പദവി"],
  mobile: ["Mobile", "മൊബൈൽ"],
  email: ["Email", "ഇമെയിൽ"],
  emergency_contact: ["Emergency contact", "അടിയന്തര ബന്ധം"],
...
const ACTION_LABELS: Record<string, [string, string]> = {
  ...
  STATUS: ["Status changed", "പദവി മാറ്റി"],
  PAY: ["Payment recorded", "പണമടയ്ക്കൽ രേഖപ്പെടുത്തി"],
  PAYMENT: ["Payment recorded", "പണമടയ്ക്കൽ രേഖപ്പെടുത്തി"],
