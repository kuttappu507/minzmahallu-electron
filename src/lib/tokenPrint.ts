...
export async function buildTokenSheetHtml(tokenList: any[], event: any, settings: any = {}, mode: TokenPrintMode = "color"): Promise<string> {
  ...
  const labels = ml ? {
    card:"കാർഡ് നമ്പർ", family:"കുടുംബം", familyNo:"കുടുംബ നമ്പർ", ward:"വാർഡ് നമ്പർ", head:"കുടുംബനാഥൻ", venue:"സ്ഥലം", event:"ഇവന്റ്"
  } : {
    card:"CARD NO", family:"FAMILY", familyNo:"FAMILY NO", ward:"WARD NO", head:"HOUSE HEAD", venue:"VENUE", event:"Event"
  };
