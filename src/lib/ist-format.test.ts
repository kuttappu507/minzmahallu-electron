...
describe("IST display helpers", () => {
  it("renders naive SQLite UTC datetimes as IST on ANY machine zone", () => {
    // 10:30 UTC == 16:00 IST — must read 16:00 regardless of the runner TZ.
    expect(formatDateTime("2026-09-19 10:30:00")).toBe("19-09-2026 16:00");
  });

  it("renders ISO-with-Z datetimes as IST", () => {
    expect(formatDateTime("2026-09-19T10:30:00Z")).toBe("19-09-2026 16:00");
  });
