...
export function Settings(){
  ...
  const checkUpdatesNow=async()=>{
    ...
    try{
      ...
      if(r.ok){ if(r.updateAvailable){setUpdState("new");setUpdVersion(r.latestVersion||"");} else setUpdState("latest"); }
