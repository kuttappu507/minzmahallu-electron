...
export function LoginPage() {
  ...
  return <div className="login-wrap">
    ...
    <div className="login-left"><div className="login-deco-1"/><div className="login-deco-2"/><div className="login-deco-3"/><div className="login-grid-overlay"/><div className="login-content"><div className="login-logo-row"><div className="login-logo-box"><b>M</b></div><div><h1 className="login-brand-name">MMS</h1><p className="login-brand-sub">{t("app_name")}</p></div></div><div><h2 className="login-hero-title">{copy.manageTitle.split("\n").map((line,i)=><span key={i}>{i>0&&<br/>}{line}</span>)}</h2><p className="login-hero-text">{t("app_subtitle")}. {copy.manageText}</p></div><div className="login-feature-row"><div className="login-feature"><ShieldCheck size={16}/><b>{copy.secured}</b></div><div className="login-feature"><Database size={16}/><b>{copy.offline}</b></div></div></div></div>
    <div className="login-right"><div className="login-form-wrap"><div className="login-mobile-logo-row lg:hidden"><div className="login-logo-box-sm"><b>M</b></div><div><h1 className="login-brand-name">MMS</h1><p className="login-brand-sub">{t("app_name")}</p></div></div>
