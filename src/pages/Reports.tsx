...
interface ReportType { id:string; title:string; description:string; tint:Tint; icon:any; fetch:()=>Promise<any[]>; columns?:string[]; labels?:Record<string,string>; dateKeys:string[]; }
